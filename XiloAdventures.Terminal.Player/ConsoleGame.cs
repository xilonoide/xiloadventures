...
using XiloAdventures.Terminal.Player.Audio;
using XiloAdventures.Terminal.Player.Screens;

namespace XiloAdventures.Terminal.Player;

/// <summary>
/// Motor principal del juego de consola para Windows Terminal
/// </summary>
public class ConsoleGame
{
    ...
    private WindowsSoundManager? _soundManager;
    ...
    // Cliente HTTP para consultas a Ollama LLM (localhost en Windows)
    ...
    private bool LoadWorld()
    {
        try
        {
            ...
            var resourceName = "XiloAdventures.Terminal.Player.world.xaw";
    ...
    {
        _soundManager = new WindowsSoundManager();
    ...
    private void ShowHelp()
    {
        ...
        ConsoleRenderer.DrawLine("  ia               - Ver estado de la IA");
        ConsoleRenderer.DrawLine("  ia on/off        - Activar/desactivar IA");
        ConsoleRenderer.DrawEmptyLine();
    ...
    private void ToggleAi()
    {
        ...
        _gameScreen.ShowMessage($"IA: {llmStatus}. Usa 'ia on' o 'ia off' para cambiar.");
    }
    ...
    private async Task ProcessAiCommandAsync(string args)
    {
        ...
        switch (arg)
        {
            ...
            case "1":
                ...
                _gameScreen.ShowMessage("IA activada. Asegurate de tener Ollama ejecutandose.");
                break;
            ...
            case "0":
                ...
                _gameScreen.ShowMessage("IA desactivada.");
                break;
    ...
    {
        // %LOCALAPPDATA%\xiloadventures\world_id
    ...
    {
        // Limpiar historial y redibujar con la nueva sala
